...
INSERT IGNORE INTO properties (id, title, description, address, price, type, bedrooms, bathrooms, area, rating, status, image_url, property_type)
VALUES
('prop1', 'Villa de Luxe Front de Mer', 'Magnifique villa avec vue imprenable sur la mer. Parfaite pour des vacances de luxe en famille.', '123 Ocean Drive, Miami, FL', 350, 'Villa', 4, 3, 2800, 4.9, 'available', 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80', 'residential'),
('prop2', 'Appartement Moderne Centre-Ville', 'Appartement élégant et moderne au cœur de la ville, proche de toutes les commodités.', '456 Main St, Seattle, WA', 180, 'Appartement', 2, 2, 1200, 4.7, 'booked', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80', 'residential'),
('prop3', 'Chalet Confortable en Montagne', 'Chalet chaleureux avec vue panoramique sur les montagnes, idéal pour les amateurs de sports d\'hiver.', '789 Pine Rd, Aspen, CO', 250, 'Chalet', 3, 2, 1800, 4.8, 'maintenance', 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80', 'residential');

-- Insérer des propriétés de bureau d'exemple
INSERT IGNORE INTO properties (id, title, description, address, price, type, workstations, meeting_rooms, area, rating, status, image_url, property_type)
VALUES
('office1', 'Espace de Coworking Moderne', 'Espace de travail partagé lumineux et dynamique, conçu pour favoriser la créativité et la collaboration.', '100 Tech Ave, San Francisco, CA', 50, 'Coworking', 20, 3, 1500, 4.7, 'available', 'https://images.unsplash.com/photo-1497215842964-222b430dc094?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80', 'office'),
('office2', 'Bureau Exécutif Centre-Ville', 'Bureau privé haut de gamme avec vue sur la ville, parfait pour les entreprises recherchant prestige et confort.', '200 Business St, New York, NY', 120, 'Bureau Exécutif', 5, 2, 800, 4.9, 'available', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80', 'office');
