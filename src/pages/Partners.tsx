          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {partners.slice(0, partners.length - remainder).map((partner, index) => (
              ...
              >
                ...
                <h2 className="text-2xl font-semibold text-[#700100] mb-3">{partner.name}</h2>
                <p className="text-lg text-gray-600 mb-6 min-h-[4rem]">
                  {t(`partners.partner_descriptions.${partner.id}`, partner.description)}
                </p>
