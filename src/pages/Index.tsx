    ...
    <CustomScrollbar className="min-h-screen">
      <div className="min-h-screen relative font-baloo">
        ...
        <div className="bg-gradient-to-br from-pastel-blue via-powder-pink to-pastel-lavender">
          ...
          {/* Values Section with enhanced fade-in animation */}
          <div 
            ref={valuesAnimation.ref as React.RefObject<HTMLDivElement>}
            className={`transition-all duration-[1200ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
          ...
          {/* About Us Section with enhanced fade-in animation */}
          <div 
            ref={aboutAnimation.ref as React.RefObject<HTMLDivElement>}
            className={`transition-all duration-[1400ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
          ...
          {/* Video Gallery Section with enhanced fade-in animation */}
          <div 
            ref={videoAnimation.ref as React.RefObject<HTMLDivElement>}
            className={`transition-all duration-[1600ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
